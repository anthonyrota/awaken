...
### <a name="disposable-function"></a>`Disposable - Function`

#### Signature

<pre>function Disposable(onDispose?: () =&gt; void): <a href="#disposable-interface">Disposable</a>;</pre>

### <a name="disposable-interface"></a>`Disposable - Interface`
...
### <a name="disposalerror-interface"></a>`DisposalError - Interface`

#### Signature

<pre>interface DisposalError extends DisposalErrorImplementation </pre>

### <a name="disposalerror-variable"></a>`DisposalError - Variable`
...
| Type | Description |
| --- | --- |
| <code>T &amp; [Disposable](#disposable-interface)</code> | <p>The given value which has been mutated. In strict javascript this is unnecessary but here it is useful as the returned value will have the type `T & Disposable`</p> |
...
This is the base construct for distributing values/messages. All things pushed and received to and from <code>[Sinks](#sink)</code> will be events. An event is an object which consists of a `type` field, which determines the type of the event. There are three types of events: <code>[Push](#push)</code>, <code>[Throw](#throw)</code> and <code>[End](#end)</code> events:
...
When determining an event's type, you should **always** use either <code>[PushType](#pushtype)</code>, <code>[ThrowType](#throwtype)</code> or <code>[EndType](#endtype)</code> directly instead of their constant number values.
...
### <a name="push-function"></a>`Push - Function`

#### Signature

<pre>function Push&lt;T&gt;(): <a href="#push-interface">Push</a>&lt;undefined&gt;;</pre>

A Push event represents the "pushing" of a value to a <code>[Sink](#sink)</code>, and has a `value` field equal to the value the event is carrying.

#### Returns

| Type | Description |
| --- | --- |
| <code>[Push](#push-interface)&lt;undefined&gt;</code> | <p>The created Push event.</p> |
...
### <a name="push-interface"></a>`Push - Interface`
...
### <a name="pushtype-typealias"></a>`PushType - Type Alias`

#### Signature

<pre>type PushType = 0;</pre>

### <a name="pushtype-variable"></a>`PushType - Variable`
...
### <a name="throw-function"></a>`Throw - Function`

#### Signature

<pre>function Throw(error: unknown): <a href="#throw-interface">Throw</a>;</pre>

A Throw represents the "throwing" of an error, and has an `error` field equal to the error the event is carrying. After a <code>[Sink](#sink)</code> receives an Error event, it will be disposed and will not take any more events.
...
### <a name="throw-interface"></a>`Throw - Interface`
...
### <a name="throwtype-typealias"></a>`ThrowType - Type Alias`

#### Signature

<pre>type ThrowType = 1;</pre>

### <a name="throwtype-variable"></a>`ThrowType - Variable`
...
### <a name="end-interface"></a>`End - Interface`

#### Signature

<pre>interface End </pre>

### <a name="end-variable"></a>`End - Variable`
...
### <a name="endtype-typealias"></a>`EndType - Type Alias`

#### Signature

<pre>type EndType = 2;</pre>

### <a name="endtype-variable"></a>`EndType - Variable`
...
### <a name="sink-function"></a>`Sink - Function`
...
### <a name="sink-interface"></a>`Sink - Interface`
...
### <a name="source-function"></a>`Source - Function`
...
### <a name="source-interface"></a>`Source - Interface`
...
| Type | Description |
| --- | --- |
| <code>T</code> | <p>The result of accumulatively calling the given value against all of the functions given left-to-right.</p> |
...
| Type | Description |
| --- | --- |
| <code>&lt;T&gt;\(x: T\) =&gt; T</code> | <p>A function which takes a value and will return the result of accumulatively calling the value against all of the functions given left-to-right.</p> |
...
### <a name="subject-interface"></a>`Subject - Interface`
...
### <a name="subjectdistributionsinkdisposalerror-interface"></a>`SubjectDistributionSinkDisposalError - Interface`

#### Signature

<pre>interface SubjectDistributionSinkDisposalError extends SubjectDistributionSinkDisposalErrorImplementation </pre>

### <a name="subjectdistributionsinkdisposalerror-variable"></a>`SubjectDistributionSinkDisposalError - Variable`
