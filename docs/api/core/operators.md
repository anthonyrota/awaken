...
### <a name="debouncetrailingrestart-typealias"></a>`DebounceTrailingRestart - Type Alias`

#### Signature

<pre>type DebounceTrailingRestart = 'restart';</pre>

### <a name="debouncetrailingrestart-variable"></a>`DebounceTrailingRestart - Variable`
